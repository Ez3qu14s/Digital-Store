...
export default function Header() {
    ...
    return (
        <>
            <header className="px-5 py-3 bg-white fixed w-full z-20 md:px-14">
                ...
                <div className="flex bg-light-gray-3 w-full justify-between rounded-md mt-5 px-4 py-2 md:hidden" style={{ display: mostrarPesquisa ? "flex" : "none" }}>
                    <input type="text" placeholder='Pesquisar produtos...'
                        className='bg-transparent w-full outline-none'
                    />
                    <CiSearch className='text-[20px]' />
            ...
            {/* Menu Lateral - Mobile */}
            <div className='bg-black/50 w-screen h-screen fixed top-12 z-10 md:hidden'
            ...
            >
                <div className='w-[80%] bg-white h-[97%] px-5 py-6 flex flex-col justify-between'>
                    ...
                    <div className='mb-[35px] flex flex-col gap-2'>
                        ...
                        <button className='w-full text-white bg-primary rounded-md p-2 mt-2'>Entrar</button>
                        <button className='w-full text-dark-gray-2 underline'>Cadastre-se</button>
                    </div>
                </div>
            </div>
                <NavBar />
